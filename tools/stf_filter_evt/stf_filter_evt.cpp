...
static STFFilterConfig parse_command_line (int argc, char **argv) {
    ...
    parser.addMultiFlag('E', "evt", "Event to filter, i.e. -E 0x105 -E 0x102");
    parser.addFlag('K', "filter all kernel activies, not including syscalls");
    parser.addFlag('S', "filter all syscalls, keeping the SVC instructions");
...
int main (int argc, char **argv)
{
    try {
        ...
        */
        ...
        stf_writer.addTraceInfo(stf::TraceInfoRecord(stf::STF_GEN::STF_GEN_STF_FILTER_EVT,
                                                     stf::STF_CUR_VERSION_MAJOR,
                                                     stf::STF_CUR_VERSION_MINOR,
                                                     0,
                                                     "Merge trace generated by stf_filter_evt"));
        stf::STFRegState regState;
