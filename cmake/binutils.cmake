...
if(DISABLE_BINUTILS)
    ...
    elseif(CMAKE_BUILD_TYPE MATCHES "^[Ff]ast[De]bug")
        set(BINUTILS_CFLAGS "${BINUTILS_CFLAGS} -O3 -g")
        set(BINUTILS_CXXFLAGS "${BINUTILS_CXXFLAGS} -O3 -g")
        set(BINUTILS_LDFLAGS "${BINUTILS_LDFLAGS} -Wl,-O3 -g")
    else()
        set(BINUTILS_CFLAGS "${BINUTILS_CFLAGS} -O3")
        set(BINUTILS_CXXFLAGS "${BINUTILS_CXXFLAGS} -O3")
